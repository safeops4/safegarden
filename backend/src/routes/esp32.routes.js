...
router.post("/pair", Esp32Controller.pair);
...
router.get("/status", verifyToken, Esp32Controller.getStatus);
router.post("/generate-code", verifyToken, Esp32Controller.generatePairingCode);
